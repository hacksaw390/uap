  ...
  <section id="professor">
    <div class="container mt-5">
      <div class="row justify-content-center">
        <div v-for="(professor, i) in assistantList" :key="i" class="col-md-6">
          <div
              ...
              <div class="col-sm-8 main-info">
                ...
                >
                  ...
                  <div>
                    <ul class="nav">
                      <li
                        v-for="(item, j) in socalicons"
                        :key="j"
                        class="nav-item"
                      >
                        <nuxt-link class="nav-link p-1 icon" to=""
                          ><img :src="item.img"
                        /></nuxt-link>
                      </li>
                    </ul>
                  ...
                  <div>
                    <button class="primary-btn readmore">
  ...
  data() {
    return {
      socalicons: [
        ...
        // { img: require('../../../static/images/faculty/Path 5.png') },
      ],
    }
  },
}
