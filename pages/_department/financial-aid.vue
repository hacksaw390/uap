<template>
  <section class="about-section">
    ...
    <Overview
      ...
      :overview-informations="overviewInformations"
    />
    <NewStudent
      v-show="programmenu[1].active == true"
      :new-student-informations="newStudentInformations"
      :specials="specials"
    />
    <CurrentStudent
      v-show="programmenu[2].active == true"
      :current-student-informations="currentStudentInformations"
      :current-special="currentSpecial"
    />
    <SpecialWaiver
      v-show="programmenu[3].active == true"
      :special-waiver-informations="specialWaiverInformations"
    />
    <General
...
import Overview from '../../components/departmens/financial-aid/Overview.vue'
import CurrentStudent from '../../components/departmens/financial-aid/Current-student.vue'
import NewStudent from '../../components/departmens/financial-aid/New-student.vue'
import SpecialWaiver from '../../components/departmens/financial-aid/Special-waiver.vue'
import General from '../../components/departmens/financial-aid/General.vue'
import Calculator from '../../components/departmens/financial-aid/Calculator.vue'
export default {
  components: {
    Banner,
    Header,
