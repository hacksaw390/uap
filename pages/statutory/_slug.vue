<template>
  <div class="container">
    <div class="members-list-card card">
      ...
      <div v-if="statutoryList.data" class="card-body">
        <div class="row">
          <div
            v-for="(member, key) in statutoryList.data"
        ...
        <div class="row">
          <template v-for="(member, key) in statutoryList.data">
            <div
      ...
      <div v-else class="card-body">not available member</div>
    </div>
  </div>
</template>
<script>
